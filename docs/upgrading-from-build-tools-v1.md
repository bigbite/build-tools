...
## `dist` directory is now `build`

This aligns with wp-scripts naming conventions and ensures that wp-scripts works as expected. For example, certain actions will auto-ignore files in the `build` directory.
